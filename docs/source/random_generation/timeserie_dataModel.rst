...
- Take a timeserie :math:`a` measured on a dataset, defined on a set of timestamps :math:`T`, and the number of interactions of the anomaly :math:`C_{an}`.

- Sort the timeserie :math:`a` in increasing value order
...
- Define 'normality' timeserie as :math:`a_{norm}(t) = a(t) - a_{an}(t), \forall t \in T`
